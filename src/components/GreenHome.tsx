...
export default function GreenHome() {
  return (
    <div className="mx-auto mt-16 max-w-7xl rounded-3xl bg-white ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
      <div className="p-8 sm:p-10 lg:flex-auto">
        <h3 className="text-2xl font-bold tracking-tight text-gray-900">
          Lifetime membership
        </h3>
        <p className="mt-6 text-base leading-7 text-gray-600">
          Discover a cleaner, healthier lifestyle with our Green Home Solutions,
          integrating cutting-edge technologies for an Eco-conscious living
          space.
        </p>
